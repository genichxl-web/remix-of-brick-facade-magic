...
Если клиент спрашивает сколько стоит забор ответь что стоимость забора зависит от многоих параметров, но очень усредненно можно орентироваться на 25000 рублей за погонный метр забора включая откатные ворота и калитку 
